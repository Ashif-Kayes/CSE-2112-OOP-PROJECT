...
public class SignupThree extends  JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        JLabel chAccount=new JLabel("*");
       chAccount.setForeground(Color.red);
       chAccount.setFont(new Font("Raleway",Font.PLAIN,20));
       chAccount.setBounds(90,145,20,15);
       add(chAccount);
        ...
        carddetail.setBounds(330,330,300,20);
        add(carddetail);
        ...
        JLabel chService=new JLabel("*");
       chService.setForeground(Color.red);
       chService.setFont(new Font("Raleway",Font.PLAIN,20));
       chService.setBounds(90,455,20,15);
       add(chService);
        ...
        add(c6);
         ...
         c7=new JCheckBox("I hereby declares that the above entered details are correct to the best way of my knowledge ");
